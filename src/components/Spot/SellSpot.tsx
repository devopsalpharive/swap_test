    ...
    <div>
      ...
      <div className="px-2 py-0">
        {activeTab === "open" && (
          <>
            {/* Quantity Selector */}
            <div className="flex justify-between mt-3 mb-4 items-center dark:text-white text-sm">
            ...
            {/* Trade Information */}
            <div className="mt-2 dark:text-white text-[16px] space-y-2">
              <p>
        ...
        {activeTab === "closed" && (
          <>
            {/* Quantity Selector */}
            <div className="flex justify-between mt-4 items-center mb-2 dark:text-white text-sm">
              <span className="text-[12px]">
                Available:{" "}
                <span className="font-semibold">{balance.toFixed(6)} USDT</span>
              </span>
            ...
            <div className="flex justify-between dark:bg-[#3d3d3d] bg-[#e5e5e5] rounded-lg pt-2 px-3 mt-4">
              <div className="">
                <p className="text-black dark:text-white">Total</p>
                <input
                  className="h-[20px] w-[50px] bg-transparent mt-[4px] text-gray-500 dark:text-gray-300 placeholder-gray-400 outline-none"
            ...
            {/* Buy/Sell Button */}
            {
              token !== null ? (
                <GradientButton
                  text={`Sell ${base}`}
                  width="w-full"
                  className={"px-5 py-2 mt-7 bg-red "}
                // className={`text-black dark:text-white transition-transform ${
                //   isOpen ? "rotate-180" : ""
                // }`}
                />
