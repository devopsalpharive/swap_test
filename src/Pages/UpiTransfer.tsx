  ...
  return (
    <div className="mt-11 md:mt-auto">
      ...
      <div className="mt-10 max-w-[750px] m-auto">
        <h2 className="flex dark:text-white text-[20px]">UPI</h2>
        <div className="mt-5">
        ...
        <div className="mt-5">
          <label className="dark:text-white">UPI ID </label>
          <div
            className={`flex items-center border border-[#237249] rounded-lg px-3 mt-4 py-2 bg-white dark:bg-[#23262F]`}
          >
            <input
        ...
        <div className="mt-5">
        <label className="dark:text-white">UPI QR code(Optional)</label>
